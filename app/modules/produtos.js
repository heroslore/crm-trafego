...
import { kpis, resumoProduto, serieDiaria, porEntidade } from "../core/metrics.js?v=edb6a568";
import { classificarProduto, CLASSES_PRODUTO } from "../core/rules.js?v=edb6a568";
import { cartao, tabela, badge, chips, abrirFormulario, vazio, itemLista, graficoLinhas, kpi, progresso } from "../core/ui.js?v=edb6a568";
