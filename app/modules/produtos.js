...
import { kpis, resumoProduto, serieDiaria, porEntidade } from "../core/metrics.js?v=890e3831";
import { classificarProduto, CLASSES_PRODUTO } from "../core/rules.js?v=890e3831";
import { cartao, tabela, badge, chips, abrirFormulario, vazio, itemLista, graficoLinhas, kpi, progresso } from "../core/ui.js?v=890e3831";
