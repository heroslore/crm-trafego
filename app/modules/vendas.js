...
import { kpis, vendasNoPeriodo, custoDaVenda, porEntidade, liquidoDaVenda, taxaPagamento, vendaVale } from "../core/metrics.js?v=e40367ec";
import { cartao, tabela, badge, badgeOpcao, abrirFormulario, vazio, kpi, barrasH, toast, itemLista } from "../core/ui.js?v=e40367ec";
import { esc, brl, inteiro, pct, mult, dataBR, hoje, agora } from "../core/format.js?v=e40367ec";
