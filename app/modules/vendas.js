...
import { kpis, vendasNoPeriodo, custoDaVenda, porEntidade } from "../core/metrics.js?v=c59cb573";
import { cartao, tabela, badge, badgeOpcao, abrirFormulario, vazio, kpi, barrasH, toast, itemLista } from "../core/ui.js?v=c59cb573";
import { esc, brl, inteiro, pct, mult, dataBR, hoje, agora } from "../core/format.js?v=c59cb573";
