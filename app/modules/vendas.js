...
import { kpis, vendasNoPeriodo, custoDaVenda, porEntidade, liquidoDaVenda, taxaPagamento, vendaVale } from "../core/metrics.js?v=ebf7a3c7";
import { cartao, tabela, badge, badgeOpcao, abrirFormulario, vazio, kpi, barrasH, toast, itemLista } from "../core/ui.js?v=ebf7a3c7";
import { esc, brl, inteiro, pct, mult, dataBR, hoje, agora } from "../core/format.js?v=ebf7a3c7";
