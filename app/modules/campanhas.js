...
import { kpis, serieDiaria, porEntidade, mediaCampanhas } from "../core/metrics.js?v=02b90ebf";
import { situacaoCampanha } from "../core/rules.js?v=02b90ebf";
import { cartao, tabela, badge, badgeOpcao, chips, abrirFormulario, vazio, itemLista, graficoLinhas, kpi, prioridadeBadge, modal, fecharModal, toast, formulario, lerFormulario } from "../core/ui.js?v=02b90ebf";
import { esc, brl, inteiro, pct, mult, dataBR, dataCurta, hoje, dec } from "../core/format.js?v=02b90ebf";
import { bannerDemo, btnNovo, linhaNumeros } from "./comum.js?v=02b90ebf";
