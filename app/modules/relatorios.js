...
import { kpis, comparar, porEntidade, serieDiaria, METRICAS_ROTULOS, MENOR_MELHOR } from "../core/metrics.js?v=bb300066";
import { relatorio, analise } from "../core/rules.js?v=bb300066";
import { intervalo, anterior, rotulo as rotuloPeriodo } from "../core/periods.js?v=bb300066";
import { cartao, tabela, vazio, kpi, abas, chips, graficoLinhas, itemLista, delta, fmtMetrica } from "../core/ui.js?v=bb300066";
import { esc, brl, inteiro, pct, mult, dataBR, dataCurta, hoje, somaDias, seta, variacao } from "../core/format.js?v=bb300066";
import { bannerDemo } from "./comum.js?v=bb300066";
