...
import { kpis, comparar, porEntidade, serieDiaria, METRICAS_ROTULOS, MENOR_MELHOR } from "../core/metrics.js?v=c59cb573";
import { relatorio, analise } from "../core/rules.js?v=c59cb573";
import { intervalo, anterior, rotulo as rotuloPeriodo } from "../core/periods.js?v=c59cb573";
import { cartao, tabela, vazio, kpi, abas, chips, graficoLinhas, itemLista, delta, fmtMetrica } from "../core/ui.js?v=c59cb573";
import { esc, brl, inteiro, pct, mult, dataBR, dataCurta, hoje, somaDias, seta, variacao } from "../core/format.js?v=c59cb573";
import { bannerDemo } from "./comum.js?v=c59cb573";
