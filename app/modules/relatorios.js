...
import { kpis, comparar, porEntidade, serieDiaria, METRICAS_ROTULOS, MENOR_MELHOR } from "../core/metrics.js?v=02b90ebf";
import { relatorio, analise } from "../core/rules.js?v=02b90ebf";
import { intervalo, anterior, rotulo as rotuloPeriodo } from "../core/periods.js?v=02b90ebf";
import { cartao, tabela, vazio, kpi, abas, chips, graficoLinhas, itemLista, delta, fmtMetrica } from "../core/ui.js?v=02b90ebf";
import { esc, brl, inteiro, pct, mult, dataBR, dataCurta, hoje, somaDias, seta, variacao } from "../core/format.js?v=02b90ebf";
import { bannerDemo } from "./comum.js?v=02b90ebf";
