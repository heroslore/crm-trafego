...
import { kpis, comparar, porEntidade, serieDiaria, METRICAS_ROTULOS, MENOR_MELHOR } from "../core/metrics.js";
import { relatorio, analise } from "../core/rules.js";
import { intervalo, anterior, rotulo as rotuloPeriodo } from "../core/periods.js";
import { cartao, tabela, vazio, kpi, abas, chips, graficoLinhas, itemLista, delta, fmtMetrica } from "../core/ui.js";
import { esc, brl, inteiro, pct, mult, dataBR, dataCurta, hoje, somaDias, seta, variacao } from "../core/format.js";
import { bannerDemo } from "./comum.js";
