...
import { kpis, comparar, porEntidade, serieDiaria, METRICAS_ROTULOS, MENOR_MELHOR } from "../core/metrics.js?v=b1025fca";
import { relatorio, analise } from "../core/rules.js?v=b1025fca";
import { intervalo, anterior, rotulo as rotuloPeriodo } from "../core/periods.js?v=b1025fca";
import { cartao, tabela, vazio, kpi, abas, chips, graficoLinhas, itemLista, delta, fmtMetrica } from "../core/ui.js?v=b1025fca";
import { esc, brl, inteiro, pct, mult, dataBR, dataCurta, hoje, somaDias, seta, variacao } from "../core/format.js?v=b1025fca";
