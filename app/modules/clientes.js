...
import { clientes, ltvPorCampanha, liquidoDaVenda } from "../core/metrics.js?v=edb6a568";
import { cartao, tabela, badge, vazio, kpi, abas, itemLista, barrasH } from "../core/ui.js?v=edb6a568";
import { esc, brl, inteiro, pct, dataBR, waLink, semAcento, diasEntre, hoje, dec } from "../core/format.js?v=edb6a568";
