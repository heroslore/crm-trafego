import { db, inserirDemonstracao } from "../core/db.js?v=bb300066";
import { cartao, tabela, badge, badgeOpcao, abrirFormulario, vazio, abas, toast, modal, fecharModal, kpi } from "../core/ui.js?v=bb300066";
import { esc, dataBR, horaCurta, brl, inteiro } from "../core/format.js?v=bb300066";
import { rotulo as rotuloOpcao, OPCOES } from "../core/schema.js?v=bb300066";
import { PERMISSOES, ehAdmin, podeEditar, usuario } from "../core/auth.js?v=bb300066";
import { nuvem, nuvemLigada, conectar, desconectar, sincronizar, carregarMeta, META } from "../core/sync.js?v=bb300066";
import { lerCSV, lerXLSX, mapearColunas, importar, CAMPOS_IMPORT } from "../core/importer.js?v=bb300066";
import * as W from "../core/wame.js?v=bb300066";
import { REFERENCIA_PADRAO, mesclarReferencia, MENOR_MELHOR } from "../core/analise/benchmarks.js?v=bb300066";
import { MINIMOS } from "../core/analise/confianca.js?v=bb300066";
import * as MetaApi from "../core/meta.js?v=bb300066";
import { MODOS_VENDA, MODO_VENDA_PADRAO, normalizarModoVenda } from "../core/analise/index.js?v=bb300066";
