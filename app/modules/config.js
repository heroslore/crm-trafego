import { db, inserirDemonstracao } from "../core/db.js?v=e40367ec";
import { cartao, tabela, badge, badgeOpcao, abrirFormulario, vazio, abas, toast, modal, fecharModal, kpi } from "../core/ui.js?v=e40367ec";
import { esc, dataBR, horaCurta, brl, inteiro } from "../core/format.js?v=e40367ec";
import { rotulo as rotuloOpcao, OPCOES } from "../core/schema.js?v=e40367ec";
import { PERMISSOES, ehAdmin, podeEditar, usuario } from "../core/auth.js?v=e40367ec";
import { nuvem, nuvemLigada, conectar, desconectar, sincronizar, carregarMeta, META } from "../core/sync.js?v=e40367ec";
import { lerCSV, lerXLSX, mapearColunas, importar, CAMPOS_IMPORT } from "../core/importer.js?v=e40367ec";
import * as W from "../core/wame.js?v=e40367ec";
import { REFERENCIA_PADRAO, mesclarReferencia, MENOR_MELHOR } from "../core/analise/benchmarks.js?v=e40367ec";
import { MINIMOS } from "../core/analise/confianca.js?v=e40367ec";
import * as MetaApi from "../core/meta.js?v=e40367ec";
import { MODOS_VENDA, MODO_VENDA_PADRAO, normalizarModoVenda } from "../core/analise/index.js?v=e40367ec";
