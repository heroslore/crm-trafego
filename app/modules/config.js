import { db, inserirDemonstracao } from "../core/db.js?v=f9372346";
import { cartao, tabela, badge, badgeOpcao, abrirFormulario, vazio, abas, toast, modal, fecharModal, kpi } from "../core/ui.js?v=f9372346";
import { esc, dataBR, horaCurta, brl, inteiro } from "../core/format.js?v=f9372346";
import { rotulo as rotuloOpcao, OPCOES } from "../core/schema.js?v=f9372346";
import { PERMISSOES, ehAdmin, podeEditar, usuario } from "../core/auth.js?v=f9372346";
import { nuvem, nuvemLigada, conectar, desconectar, sincronizar, carregarMeta, META } from "../core/sync.js?v=f9372346";
import { lerCSV, lerXLSX, mapearColunas, importar, CAMPOS_IMPORT } from "../core/importer.js?v=f9372346";
import * as W from "../core/wame.js?v=f9372346";
import { REFERENCIA_PADRAO, mesclarReferencia, MENOR_MELHOR } from "../core/analise/benchmarks.js?v=f9372346";
import { MINIMOS } from "../core/analise/confianca.js?v=f9372346";
import * as MetaApi from "../core/meta.js?v=f9372346";
import { MODOS_VENDA, MODO_VENDA_PADRAO, normalizarModoVenda } from "../core/analise/index.js?v=f9372346";
