...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=302fb635";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=302fb635";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=302fb635";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=302fb635";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=302fb635";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=302fb635";
import { alertas } from "./core/rules.js?v=302fb635";
import * as W from "./core/wame.js?v=302fb635";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=302fb635";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=302fb635";

import dashboard from "./modules/dashboard.js?v=302fb635";
import hoje_ from "./modules/hoje.js?v=302fb635";
import inbox from "./modules/inbox.js?v=302fb635";
import decisoes from "./modules/decisoes.js?v=302fb635";
import campanhas from "./modules/campanhas.js?v=302fb635";
import anuncios from "./modules/anuncios.js?v=302fb635";
import criativos from "./modules/criativos.js?v=302fb635";
import produtos from "./modules/produtos.js?v=302fb635";
import publicos from "./modules/publicos.js?v=302fb635";
import leads from "./modules/leads.js?v=302fb635";
import vendas from "./modules/vendas.js?v=302fb635";
import clientes from "./modules/clientes.js?v=302fb635";
import financeiro from "./modules/financeiro.js?v=302fb635";
import testes from "./modules/testes.js?v=302fb635";
import planejamento from "./modules/planejamento.js?v=302fb635";
import tarefas from "./modules/tarefas.js?v=302fb635";
import calendario from "./modules/calendario.js?v=302fb635";
import briefings from "./modules/briefings.js?v=302fb635";
import ideias from "./modules/ideias.js?v=302fb635";
import relatorios from "./modules/relatorios.js?v=302fb635";
import calculadoras from "./modules/calculadoras.js?v=302fb635";
import concorrentes from "./modules/concorrentes.js?v=302fb635";
import config from "./modules/config.js?v=302fb635";
