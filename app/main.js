...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=99e88144";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=99e88144";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=99e88144";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=99e88144";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=99e88144";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=99e88144";
import { alertas } from "./core/rules.js?v=99e88144";
import * as W from "./core/wame.js?v=99e88144";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=99e88144";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=99e88144";

import dashboard from "./modules/dashboard.js?v=99e88144";
import hoje_ from "./modules/hoje.js?v=99e88144";
import inbox from "./modules/inbox.js?v=99e88144";
import decisoes from "./modules/decisoes.js?v=99e88144";
import campanhas from "./modules/campanhas.js?v=99e88144";
import anuncios from "./modules/anuncios.js?v=99e88144";
import criativos from "./modules/criativos.js?v=99e88144";
import produtos from "./modules/produtos.js?v=99e88144";
import publicos from "./modules/publicos.js?v=99e88144";
import leads from "./modules/leads.js?v=99e88144";
import vendas from "./modules/vendas.js?v=99e88144";
import clientes from "./modules/clientes.js?v=99e88144";
import financeiro from "./modules/financeiro.js?v=99e88144";
import testes from "./modules/testes.js?v=99e88144";
import planejamento from "./modules/planejamento.js?v=99e88144";
import tarefas from "./modules/tarefas.js?v=99e88144";
import calendario from "./modules/calendario.js?v=99e88144";
import briefings from "./modules/briefings.js?v=99e88144";
import ideias from "./modules/ideias.js?v=99e88144";
import relatorios from "./modules/relatorios.js?v=99e88144";
import calculadoras from "./modules/calculadoras.js?v=99e88144";
import concorrentes from "./modules/concorrentes.js?v=99e88144";
import config from "./modules/config.js?v=99e88144";
