...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=72aad7ae";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=72aad7ae";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=72aad7ae";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=72aad7ae";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=72aad7ae";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=72aad7ae";
import { alertas } from "./core/rules.js?v=72aad7ae";
import * as W from "./core/wame.js?v=72aad7ae";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=72aad7ae";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=72aad7ae";

import dashboard from "./modules/dashboard.js?v=72aad7ae";
import hoje_ from "./modules/hoje.js?v=72aad7ae";
import inbox from "./modules/inbox.js?v=72aad7ae";
import decisoes from "./modules/decisoes.js?v=72aad7ae";
import campanhas from "./modules/campanhas.js?v=72aad7ae";
import anuncios from "./modules/anuncios.js?v=72aad7ae";
import criativos from "./modules/criativos.js?v=72aad7ae";
import produtos from "./modules/produtos.js?v=72aad7ae";
import publicos from "./modules/publicos.js?v=72aad7ae";
import leads from "./modules/leads.js?v=72aad7ae";
import vendas from "./modules/vendas.js?v=72aad7ae";
import clientes from "./modules/clientes.js?v=72aad7ae";
import financeiro from "./modules/financeiro.js?v=72aad7ae";
import testes from "./modules/testes.js?v=72aad7ae";
import planejamento from "./modules/planejamento.js?v=72aad7ae";
import tarefas from "./modules/tarefas.js?v=72aad7ae";
import calendario from "./modules/calendario.js?v=72aad7ae";
import briefings from "./modules/briefings.js?v=72aad7ae";
import ideias from "./modules/ideias.js?v=72aad7ae";
import relatorios from "./modules/relatorios.js?v=72aad7ae";
import calculadoras from "./modules/calculadoras.js?v=72aad7ae";
import concorrentes from "./modules/concorrentes.js?v=72aad7ae";
import config from "./modules/config.js?v=72aad7ae";
