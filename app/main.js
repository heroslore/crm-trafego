...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=ebf7a3c7";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=ebf7a3c7";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=ebf7a3c7";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=ebf7a3c7";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=ebf7a3c7";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=ebf7a3c7";
import { alertas } from "./core/rules.js?v=ebf7a3c7";
import * as W from "./core/wame.js?v=ebf7a3c7";
import * as MetaApi from "./core/meta.js?v=ebf7a3c7";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=ebf7a3c7";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=ebf7a3c7";

import dashboard from "./modules/dashboard.js?v=ebf7a3c7";
import hoje_ from "./modules/hoje.js?v=ebf7a3c7";
import inbox from "./modules/inbox.js?v=ebf7a3c7";
import decisoes from "./modules/decisoes.js?v=ebf7a3c7";
import campanhas from "./modules/campanhas.js?v=ebf7a3c7";
import anuncios from "./modules/anuncios.js?v=ebf7a3c7";
import criativos from "./modules/criativos.js?v=ebf7a3c7";
import produtos from "./modules/produtos.js?v=ebf7a3c7";
import publicos from "./modules/publicos.js?v=ebf7a3c7";
import leads from "./modules/leads.js?v=ebf7a3c7";
import vendas from "./modules/vendas.js?v=ebf7a3c7";
import clientes from "./modules/clientes.js?v=ebf7a3c7";
import financeiro from "./modules/financeiro.js?v=ebf7a3c7";
import testes from "./modules/testes.js?v=ebf7a3c7";
import planejamento from "./modules/planejamento.js?v=ebf7a3c7";
import tarefas from "./modules/tarefas.js?v=ebf7a3c7";
import calendario from "./modules/calendario.js?v=ebf7a3c7";
import briefings from "./modules/briefings.js?v=ebf7a3c7";
import ideias from "./modules/ideias.js?v=ebf7a3c7";
import relatorios from "./modules/relatorios.js?v=ebf7a3c7";
import calculadoras from "./modules/calculadoras.js?v=ebf7a3c7";
import concorrentes from "./modules/concorrentes.js?v=ebf7a3c7";
import config from "./modules/config.js?v=ebf7a3c7";
