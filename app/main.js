...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=b1025fca";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=b1025fca";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=b1025fca";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=b1025fca";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=b1025fca";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=b1025fca";
import { alertas } from "./core/rules.js?v=b1025fca";
import * as W from "./core/wame.js?v=b1025fca";
import * as MetaApi from "./core/meta.js?v=b1025fca";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=b1025fca";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=b1025fca";

import dashboard from "./modules/dashboard.js?v=b1025fca";
import hoje_ from "./modules/hoje.js?v=b1025fca";
import inbox from "./modules/inbox.js?v=b1025fca";
import decisoes from "./modules/decisoes.js?v=b1025fca";
import campanhas from "./modules/campanhas.js?v=b1025fca";
import anuncios from "./modules/anuncios.js?v=b1025fca";
import criativos from "./modules/criativos.js?v=b1025fca";
import produtos from "./modules/produtos.js?v=b1025fca";
import publicos from "./modules/publicos.js?v=b1025fca";
import leads from "./modules/leads.js?v=b1025fca";
import vendas from "./modules/vendas.js?v=b1025fca";
import clientes from "./modules/clientes.js?v=b1025fca";
import financeiro from "./modules/financeiro.js?v=b1025fca";
import testes from "./modules/testes.js?v=b1025fca";
import planejamento from "./modules/planejamento.js?v=b1025fca";
import tarefas from "./modules/tarefas.js?v=b1025fca";
import calendario from "./modules/calendario.js?v=b1025fca";
import briefings from "./modules/briefings.js?v=b1025fca";
import ideias from "./modules/ideias.js?v=b1025fca";
import relatorios from "./modules/relatorios.js?v=b1025fca";
import calculadoras from "./modules/calculadoras.js?v=b1025fca";
import concorrentes from "./modules/concorrentes.js?v=b1025fca";
import config from "./modules/config.js?v=b1025fca";
