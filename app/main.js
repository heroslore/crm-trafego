...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=e38ac044";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=e38ac044";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=e38ac044";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=e38ac044";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=e38ac044";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=e38ac044";
import { alertas } from "./core/rules.js?v=e38ac044";
import * as W from "./core/wame.js?v=e38ac044";
import * as MetaApi from "./core/meta.js?v=e38ac044";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=e38ac044";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=e38ac044";

import dashboard from "./modules/dashboard.js?v=e38ac044";
import hoje_ from "./modules/hoje.js?v=e38ac044";
import inbox from "./modules/inbox.js?v=e38ac044";
import decisoes from "./modules/decisoes.js?v=e38ac044";
import campanhas from "./modules/campanhas.js?v=e38ac044";
import anuncios from "./modules/anuncios.js?v=e38ac044";
import criativos from "./modules/criativos.js?v=e38ac044";
import produtos from "./modules/produtos.js?v=e38ac044";
import publicos from "./modules/publicos.js?v=e38ac044";
import leads from "./modules/leads.js?v=e38ac044";
import vendas from "./modules/vendas.js?v=e38ac044";
import clientes from "./modules/clientes.js?v=e38ac044";
import financeiro from "./modules/financeiro.js?v=e38ac044";
import testes from "./modules/testes.js?v=e38ac044";
import planejamento from "./modules/planejamento.js?v=e38ac044";
import tarefas from "./modules/tarefas.js?v=e38ac044";
import calendario from "./modules/calendario.js?v=e38ac044";
import briefings from "./modules/briefings.js?v=e38ac044";
import ideias from "./modules/ideias.js?v=e38ac044";
import relatorios from "./modules/relatorios.js?v=e38ac044";
import calculadoras from "./modules/calculadoras.js?v=e38ac044";
import concorrentes from "./modules/concorrentes.js?v=e38ac044";
import config from "./modules/config.js?v=e38ac044";
