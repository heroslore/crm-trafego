...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=02b90ebf";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=02b90ebf";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=02b90ebf";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=02b90ebf";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=02b90ebf";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=02b90ebf";
import { alertas } from "./core/rules.js?v=02b90ebf";
import * as W from "./core/wame.js?v=02b90ebf";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=02b90ebf";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=02b90ebf";

import dashboard from "./modules/dashboard.js?v=02b90ebf";
import hoje_ from "./modules/hoje.js?v=02b90ebf";
import inbox from "./modules/inbox.js?v=02b90ebf";
import decisoes from "./modules/decisoes.js?v=02b90ebf";
import campanhas from "./modules/campanhas.js?v=02b90ebf";
import anuncios from "./modules/anuncios.js?v=02b90ebf";
import criativos from "./modules/criativos.js?v=02b90ebf";
import produtos from "./modules/produtos.js?v=02b90ebf";
import publicos from "./modules/publicos.js?v=02b90ebf";
import leads from "./modules/leads.js?v=02b90ebf";
import vendas from "./modules/vendas.js?v=02b90ebf";
import financeiro from "./modules/financeiro.js?v=02b90ebf";
import testes from "./modules/testes.js?v=02b90ebf";
import planejamento from "./modules/planejamento.js?v=02b90ebf";
import tarefas from "./modules/tarefas.js?v=02b90ebf";
import calendario from "./modules/calendario.js?v=02b90ebf";
import briefings from "./modules/briefings.js?v=02b90ebf";
import ideias from "./modules/ideias.js?v=02b90ebf";
import relatorios from "./modules/relatorios.js?v=02b90ebf";
import calculadoras from "./modules/calculadoras.js?v=02b90ebf";
import concorrentes from "./modules/concorrentes.js?v=02b90ebf";
import config from "./modules/config.js?v=02b90ebf";
