...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=890e3831";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=890e3831";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=890e3831";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=890e3831";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=890e3831";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=890e3831";
import { alertas } from "./core/rules.js?v=890e3831";
import * as W from "./core/wame.js?v=890e3831";
import * as MetaApi from "./core/meta.js?v=890e3831";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=890e3831";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=890e3831";

import dashboard from "./modules/dashboard.js?v=890e3831";
import hoje_ from "./modules/hoje.js?v=890e3831";
import inbox from "./modules/inbox.js?v=890e3831";
import decisoes from "./modules/decisoes.js?v=890e3831";
import campanhas from "./modules/campanhas.js?v=890e3831";
import anuncios from "./modules/anuncios.js?v=890e3831";
import criativos from "./modules/criativos.js?v=890e3831";
import produtos from "./modules/produtos.js?v=890e3831";
import publicos from "./modules/publicos.js?v=890e3831";
import leads from "./modules/leads.js?v=890e3831";
import vendas from "./modules/vendas.js?v=890e3831";
import clientes from "./modules/clientes.js?v=890e3831";
import financeiro from "./modules/financeiro.js?v=890e3831";
import testes from "./modules/testes.js?v=890e3831";
import planejamento from "./modules/planejamento.js?v=890e3831";
import tarefas from "./modules/tarefas.js?v=890e3831";
import calendario from "./modules/calendario.js?v=890e3831";
import briefings from "./modules/briefings.js?v=890e3831";
import ideias from "./modules/ideias.js?v=890e3831";
import relatorios from "./modules/relatorios.js?v=890e3831";
import calculadoras from "./modules/calculadoras.js?v=890e3831";
import concorrentes from "./modules/concorrentes.js?v=890e3831";
import config from "./modules/config.js?v=890e3831";
