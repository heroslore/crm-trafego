...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=1d8faa7d";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=1d8faa7d";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=1d8faa7d";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=1d8faa7d";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=1d8faa7d";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=1d8faa7d";
import { alertas } from "./core/rules.js?v=1d8faa7d";
import * as W from "./core/wame.js?v=1d8faa7d";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=1d8faa7d";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=1d8faa7d";

import dashboard from "./modules/dashboard.js?v=1d8faa7d";
import hoje_ from "./modules/hoje.js?v=1d8faa7d";
import inbox from "./modules/inbox.js?v=1d8faa7d";
import decisoes from "./modules/decisoes.js?v=1d8faa7d";
import campanhas from "./modules/campanhas.js?v=1d8faa7d";
import anuncios from "./modules/anuncios.js?v=1d8faa7d";
import criativos from "./modules/criativos.js?v=1d8faa7d";
import produtos from "./modules/produtos.js?v=1d8faa7d";
import publicos from "./modules/publicos.js?v=1d8faa7d";
import leads from "./modules/leads.js?v=1d8faa7d";
import vendas from "./modules/vendas.js?v=1d8faa7d";
import clientes from "./modules/clientes.js?v=1d8faa7d";
import financeiro from "./modules/financeiro.js?v=1d8faa7d";
import testes from "./modules/testes.js?v=1d8faa7d";
import planejamento from "./modules/planejamento.js?v=1d8faa7d";
import tarefas from "./modules/tarefas.js?v=1d8faa7d";
import calendario from "./modules/calendario.js?v=1d8faa7d";
import briefings from "./modules/briefings.js?v=1d8faa7d";
import ideias from "./modules/ideias.js?v=1d8faa7d";
import relatorios from "./modules/relatorios.js?v=1d8faa7d";
import calculadoras from "./modules/calculadoras.js?v=1d8faa7d";
import concorrentes from "./modules/concorrentes.js?v=1d8faa7d";
import config from "./modules/config.js?v=1d8faa7d";
