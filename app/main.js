...
import { db, garantirBase, inserirDemonstracao } from "./core/db.js?v=43ebd473";
import { PERIODOS, intervalo, rotulo as rotuloPeriodo } from "./core/periods.js?v=43ebd473";
import { esc, hoje, somaDias, semAcento } from "./core/format.js?v=43ebd473";
import { carregarUsuario, usuario, entrar, pode, PERMISSOES } from "./core/auth.js?v=43ebd473";
import { carregarMeta, nuvemLer, nuvemLigada, sincronizar, iniciarPoll, agendarEnvio, onNuvem } from "./core/sync.js?v=43ebd473";
import { iniciarAutomacoes, verificarSemResposta } from "./core/automations.js?v=43ebd473";
import { alertas } from "./core/rules.js?v=43ebd473";
import * as W from "./core/wame.js?v=43ebd473";
import { modal, fecharModal, modalAberto, toast, ordenar, prioridadeBadge } from "./core/ui.js?v=43ebd473";
import { rotulo as rotuloOpcao } from "./core/schema.js?v=43ebd473";

import dashboard from "./modules/dashboard.js?v=43ebd473";
import hoje_ from "./modules/hoje.js?v=43ebd473";
import inbox from "./modules/inbox.js?v=43ebd473";
import decisoes from "./modules/decisoes.js?v=43ebd473";
import campanhas from "./modules/campanhas.js?v=43ebd473";
import anuncios from "./modules/anuncios.js?v=43ebd473";
import criativos from "./modules/criativos.js?v=43ebd473";
import produtos from "./modules/produtos.js?v=43ebd473";
import publicos from "./modules/publicos.js?v=43ebd473";
import leads from "./modules/leads.js?v=43ebd473";
import vendas from "./modules/vendas.js?v=43ebd473";
import clientes from "./modules/clientes.js?v=43ebd473";
import financeiro from "./modules/financeiro.js?v=43ebd473";
import testes from "./modules/testes.js?v=43ebd473";
import planejamento from "./modules/planejamento.js?v=43ebd473";
import tarefas from "./modules/tarefas.js?v=43ebd473";
import calendario from "./modules/calendario.js?v=43ebd473";
import briefings from "./modules/briefings.js?v=43ebd473";
import ideias from "./modules/ideias.js?v=43ebd473";
import relatorios from "./modules/relatorios.js?v=43ebd473";
import calculadoras from "./modules/calculadoras.js?v=43ebd473";
import concorrentes from "./modules/concorrentes.js?v=43ebd473";
import config from "./modules/config.js?v=43ebd473";
