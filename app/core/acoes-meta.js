...
import * as M from "./meta.js?v=b1025fca";
import { modal, fecharModal, toast, badge } from "./ui.js?v=b1025fca";
import { esc, brl, agora, num } from "./format.js?v=b1025fca";
import { usuario, podeEditar } from "./auth.js?v=b1025fca";
