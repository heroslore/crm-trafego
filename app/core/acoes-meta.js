...
import * as M from "./meta.js?v=edb6a568";
import { modal, fecharModal, toast, badge } from "./ui.js?v=edb6a568";
import { esc, brl, agora, num } from "./format.js?v=edb6a568";
import { usuario, podeEditar } from "./auth.js?v=edb6a568";
