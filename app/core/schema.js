...
export const TABELAS = {
  ...
  campaigns: {
    titulo: "Campanhas", singular: "Campanha", campos: [
      ...
      f("target_cpa", "Meta: CPA máximo (R$)", "money", { help: "Usada pela Análise Inteligente antes de qualquer referência genérica." }),
      f("target_cpl", "Meta: CPL máximo (R$)", "money"),
      f("target_conversation_cost", "Meta: custo por conversa (R$)", "money"),
      f("target_roas", "Meta: ROAS mínimo", "number"),
      f("target_ctr", "Meta: CTR mínimo (%)", "number"),
      f("target_sales", "Meta: vendas no período", "number"),
      f("notes", "Observações", "textarea"),
  ...
  creatives: {
    titulo: "Criativos", singular: "Criativo", campos: [
      ...
      f("duration_seconds", "Duração do vídeo (segundos)", "number", { help: "Necessária para saber que parte do vídeo as pessoas assistem em média." }),
      f("hook", "Gancho usado nos 3 primeiros segundos", "text"),
      f("offer", "Oferta anunciada", "text"),
  ...
  audiences: {
    titulo: "Públicos", singular: "Público", campos: [
      ...
      f("size", "Tamanho estimado do público", "number", { help: "Número que a plataforma mostra ao montar a segmentação. Sem ele não é possível dizer se o público é pequeno ou amplo." }),
      f("notes", "Observações", "textarea"),
    ],
  },
  leads: {
  ...
  campaign_metrics: {
    titulo: "Métricas diárias", singular: "Métrica diária", campos: [
      ...
      f("outbound_clicks", "Cliques de saída (saíram do Instagram/Facebook)", "number", { help: "Métrica mais fiel de intenção que o clique no link. Deixe vazio se não tiver o número." }),
      f("landing_page_views", "Visitas à página de destino", "number", { help: "Quantas pessoas realmente carregaram a página depois do clique." }),
      f("conversations", "Conversas iniciadas", "number", { help: "Campanhas de WhatsApp/Direct: conversas que começaram." }),
      f("video_plays", "Reproduções do vídeo", "number", { help: "Quantas vezes o vídeo começou a tocar." }),
      f("video_2s", "Assistiram 2 segundos contínuos", "number"),
      f("video_3s", "Assistiram 3 segundos", "number"),
      f("thruplay", "ThruPlay (15s ou até o fim)", "number"),
      f("video_p25", "Assistiram 25%", "number"),
      f("video_p50", "Assistiram 50%", "number"),
      f("video_p75", "Assistiram 75%", "number"),
      f("video_p95", "Assistiram 95%", "number"),
      f("video_p100", "Assistiram até o fim (100%)", "number"),
      f("avg_watch", "Tempo médio assistido (segundos)", "number"),
