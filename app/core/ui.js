...
import { TABELAS, OPCOES, rotulo } from "./schema.js?v=0f43faaa";
import { esc, brl, brlCurto, inteiro, pct, mult, dec, dataBR, seta, hoje, num, uid, agora } from "./format.js?v=0f43faaa";
