...
import { TABELAS, OPCOES, rotulo } from "./schema.js?v=ebf7a3c7";
import { esc, brl, brlCurto, inteiro, pct, mult, dec, dataBR, seta, hoje, num, uid, agora } from "./format.js?v=ebf7a3c7";
