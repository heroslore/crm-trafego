...
import { TABELAS, OPCOES, rotulo } from "./schema.js?v=46e26fb2";
import { esc, brl, brlCurto, inteiro, pct, mult, dec, dataBR, seta, hoje, num, uid, agora } from "./format.js?v=46e26fb2";
