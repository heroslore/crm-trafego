...
import { TABELAS, OPCOES, rotulo } from "./schema.js?v=72aad7ae";
import { esc, brl, brlCurto, inteiro, pct, mult, dec, dataBR, seta, hoje, num, uid, agora } from "./format.js?v=72aad7ae";
