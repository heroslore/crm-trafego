...
import { TABELAS, OPCOES, rotulo } from "./schema.js?v=edb6a568";
import { esc, brl, brlCurto, inteiro, pct, mult, dec, dataBR, seta, hoje, num, uid, agora } from "./format.js?v=edb6a568";
