...
import { TABELAS, OPCOES, rotulo } from "./schema.js?v=302fb635";
import { esc, brl, brlCurto, inteiro, pct, mult, dec, dataBR, seta, hoje, num, uid, agora } from "./format.js?v=302fb635";
