...
import { kpis, serieDiaria, porEntidade, atendimento, plataformaBase } from "../metrics.js?v=b1025fca";
import { anterior } from "../periods.js?v=b1025fca";
import { META } from "../sync.js?v=b1025fca";
import { num, hoje, somaDias, diasEntre, pct, brl, inteiro, dec } from "../format.js?v=b1025fca";
import { metricasCalculadas, contagemOuNulo, numeroOuNulo, razao } from "./metricas.js?v=b1025fca";
import { construirBenchmarks, mesclarReferencia, MENOR_MELHOR } from "./benchmarks.js?v=b1025fca";
import { confianca, MINIMOS } from "./confianca.js?v=b1025fca";
import { cartoesEtapa, diagnosticos, saudePublico, fadiga, gargaloRelativo } from "./regras.js?v=b1025fca";
import { pontuar } from "./score.js?v=b1025fca";
import { plano, gargalos, pontosFortes, resumo10s } from "./recomendacoes.js?v=b1025fca";
